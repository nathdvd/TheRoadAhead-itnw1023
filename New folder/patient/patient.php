    ...
    <div class="container">
        <div class="menu" style="background-color:#2F323A;">
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-rate">
        ...
        <?php       
                ...
                ?>
        <div class="dash-body">
            <p style="font-size:40px; margin-top:10px; margin-bottom: 5px; font-weight:800; color: white; text-align: center; text-shadow: 5px 5px 10px black">Samal <span style="color: #1DC4E7;">Dialysis</span> Center</p>
