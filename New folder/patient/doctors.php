    ...
    <div class="container">
        ...
        <div class="dash-body">
            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    <td width="13%">
                        <a href="doctors.php" ><button  class="login-btn btn-primary-soft btn btn-icon-back"  style="padding-top:11px; padding-bottom:11px; margin-left:20px; color: black; width:125px"><font class="tn-in-text">Back</font></button></a>
                    </td>
                    <td>
                        
                        <form action="" method="post" class="header-search">

                            <input type="search" name="search" class="input-text header-searchbar" placeholder="Search Courses" list="doctors">&nbsp;&nbsp;
...
?>
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;">
                        <p class="heading-main12" style="margin-left: 45px;font-size:20px; font-weight: 600; color:black;">All Courses (<?php echo $list11->num_rows; ?>)</p>
                    </td>
                ...
                <tr>
                   <td colspan="4" >
                       <center >
                        ...
                        <table width="93%"  style="background-color:white; border:solid;" class="sub-table scrolldown" border="0">
                        <thead >
                        <tr>
    ...
    if($_GET){
        ...
        if($action=='drop'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <div class="content" style="font-size:35px; color:green; font-weight:800;">
                            B2B Driving <span style="color:red;">School</span> <br>
            ...
            <div id="popup1" class="overlay">
                    <div class="popup">
                    <center>
                        <h2>Redirect to Instructors sessions?</h2>
                        <a class="close" href="doctors.php">&times;</a>
                        <div class="content">
                    ...
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="text" name="name" class="input-text" placeholder="Instructor Name" value="'.$name.'" required><br>
                                        </td>
