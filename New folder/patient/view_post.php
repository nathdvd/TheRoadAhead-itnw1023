...
<section class="one-reviews-container">
   ...
   <div class="one-heading"><h1 style="color: white;">user's reviews</h1> <a href="add_review.php?get_id=<?= $get_id; ?>" class="one-inline-btn" style="margin-top: 0;">add review</a></div>
