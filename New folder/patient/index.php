        ...
        <div class="dash-body" style="margin-top: 15px">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                ...
                <tr>
                    ...
                    <center>
                    <table class="filter-container doctor-header " style="border:none; background-image: url(../img/bb.jpg); width:95%" border="0" >
                    <tr>
                        <td >
                            <h3>Welcome!</h3>
                            <h1>"<?php echo $username  ?>"</h1>
                            <p>Do you want to schedule in <span style="font-weight: 800;">B2B Driving School?</span> No problem let's jump to 
                                <a href="doctors.php" class="non-style-link"><b>"All Courses"</b></a> section or 
                                <a href="schedule.php" class="non-style-link"><b>"Schedule".</b> 
                            </p>
                            
                            <h3>Search Instructor Schedule Here</h3>
                            <form action="schedule.php" method="post" style="display: flex">

                                <input type="search" name="search" class="input-text " placeholder="Search Courses and We will Find The Session Available" list="doctors" style="width:45%;">&nbsp;&nbsp;
                        ...
                        <table border="0" width="100%">
                            <tr>
                                <td width="50%">
                                    ...
                                    <center>
                                        <table class="filter-container" style="background-color:white; height: 400px; border: solid;" border="0">
                                            <tr>
                                                <td colspan="4">
                                                    <p style="font-size:40px;font-weight:600;padding-left: 12px; text-align: center; margin-bottom: 10px;" >Status</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 25%;">
                                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:80%;display: flex">
                                                        <div>
                                                ...
                                                <td style="width: 25%;">
                                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;margin-top: -45%; height: 100%; width:80%;display: flex;padding-top:30px;padding-bottom:21px;">
                                                        <div>
                                                                <div class="h1-dashboard">
                                ...
                                <td>
                                    ...
                                    <p style=" color: black; margin-bottom: 0px; border: none; border-radius: .5rem; background-color: white; font-size: 25px;font-weight:800;padding-left: 40px;" class="anime">Your Upcoming Booking</p>
                                    <center>
                                        <div class="abc scroll" style="color: black; width: 750px; background-color: white; border-radius: .5rem;height: 300px;padding: 0;margin: 0;">
