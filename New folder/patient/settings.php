...
<body>
    ...
    <div class="container">
        ...
        <div class="dash-body">
            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin-top:0;padding:0;" >
                    ...
                    <a href="settings.php" ><button  class="login-btn btn-primary-soft btn btn-icon-back"  style="padding-top:11px; padding-bottom:11px;margin-left:20px;width:125px">
                        <font class="tn-in-text" style="color:black;">Back</font></button></a>
                    </td>
                    <td>
                        <p style="font-size:40px; padding-top:11px; font-weight:800; text-shadow: 1px 1px 1px white; text-align:center;">Settings</p>
                        ...
                        <table class="filter-container" style="border: none;" border="0">
                            ...
                            <tr>
                                <td style="width: 25%;">
                                    ...
                                    <div  class="dashboard-items setting-tabs"  style="padding:20px; margin:auto; color: black; background-color: white; width:95%; display:flex; border:solid; border-color:black;">
        ...
        if($action=='drop'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <div class="content" style="font-weight:800; color:white; font-size:35px;" >
                            B<span style="color:red;">2</span>B Driving School<br>
                            
                        </div>
                        <div style="display:flex; justify-content: center;">
                        <table width="80%" style="background-color:white;" class="sub-table scrolldown add-doc-form-container" border="0">
            ...
            if($error_1!='4'){
                    ...
                    <div id="popup1" class="overlay" >
                            <div class="popup" style="background-color:#2F323A;">
                            <center>
                                <p style="font-weight:800; margin:0; color:white; font-size:35px;">B<span style="color:red;">2</span>B Driving School</p>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="tel" name="Tele" class="input-text" maxlength="11" placeholder="Telephone Number" value="'.$tele.'" required><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="password" name="password" class="input-text" placeholder="Input Password" required><br>
                                        </td>
                                    </tr><tr>
                                        <td class="label-td" colspan="2">
