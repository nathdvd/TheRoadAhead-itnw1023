            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;width: 100%;" >
                        <p style="font-size: 35px; text-align: center; margin-top: 5px; padding-left:12px; font-weight: 800;">Schedule history</p>
                        <p class="heading-main12" style=" margin-left: 45px; font-weight: 800; font-size:25px; color:black; ">My Bookings (<?php echo $result->num_rows; ?>)</p>
                    </td>
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                if($result->num_rows==0){
                                    ...
                                    <br>
                                    <p class="heading-main12" style="margin-left: 45px;font-size:25px;color:black; text-shadow:.5px .5px .8px white;">We  couldnt find anything related to your keywords !</p>
