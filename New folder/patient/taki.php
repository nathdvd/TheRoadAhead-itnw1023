    ...
    <div class="container">
        <div class="menu" style="background-color:#2F323A;">
            <table class="menu-container" border="0">
                ...
                <div class="menu-row" >
                        <a href="index.php" ><i class="menu-btn menu-icon-home menu-active menu-icon-home-active"></i><span>Home</span></a>
                        <a href="doctors.php"><i class="menu-btn menu-icon-doctor"></i><span>All Doctors</span></a>
                        <a href="schedule.php"><i class="menu-btn menu-icon-session"></i><span>Scheduled Sessions</span></a>
                        <a href="appointment.php"><i class="menu-btn menu-icon-appoinment"></i><span>My Bookings</span></a>
                        <a href="settings.php"><i class="menu-btn menu-icon-settings"></i><span>Settings</span></a>
                    </div>
            </table>
        </div>
