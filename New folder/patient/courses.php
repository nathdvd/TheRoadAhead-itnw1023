...
<?php
    ...
    <div class="container">
        <div class="menu" style="background-color:#2F323A;">
            ...
            <a href="tdc.php"><button class="button1"><img src="TDC.png" height ="270" width="280"></button></a>
            <a href="pdc.php"><button class="button2"><img src="PDC.png" height ="270" width="280"></button></a>
				
            	<div class="Para1" >
                <h1 style="position: absolute; top: 22%; left: 45%; text-shadow: 5px 5px 10px black; font-size: 30px; color: white;">View Our Offer Course's Services </h1>
            	</div>

                <div class="tttt">
                    <h1>B<span style="color:red;">2</span>B Driving School</h1>
                </div>
