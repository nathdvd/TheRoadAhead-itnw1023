    ...
    <div class="container">
            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn  menu-active " >
                        <a href="appointment.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text" style="color: white;">Appointment</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                    <td class="menu-btn ">
        ...
        <div class="dash-body">
            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    <td width="13%" >
                    <a href="appointment.php" ><button  class="login-btn btn-primary-soft btn btn-icon-back"  style=" color: black;padding-top:11px; padding-bottom:11px; margin-left:20px; width:125px"><font class="tn-in-text">Back</font></button></a>
                    </td>
                    <td>
                        <p style="font-size:25px; padding-left:12px; font-weight: 800;">Appointment Section</p>
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;width: 100%;" >
                        ...
                        <p class="heading-main12" style="margin-left: 45px; font-size:20px; color:black;">All Appointments (<?php echo $list110->num_rows; ?>)</p>
                    </td>
                ...
                <tr>
                    <td colspan="4" style="padding-top:0px;width: 100%;" >
                        <center>
                        <table class="filter-container" border="0" style="background-color: #2F323A; border:ridge ; border-color:; ">
                        <tr>
                           <td width="10%">
                        ...
                        <select name="docid" id="" class="box filter-container-items" style="width:90% ;height: 37px;margin: 0;" >
                            <option value="" disabled selected hidden>Choose Instructor Name from the list</option><br/>
                ...
                <tr>
                   <td colspan="4">
                       <center>
                        ...
                        <table width="93%" class="sub-table scrolldown" border="0" style="background-color:white; border: groove; border-color:black; ">
                        <thead>
                        <tr>
