...
<body>
    ...
    <div class="container">
        ...
        <div class="dash-body">
<p style="font-size:40px; margin-top:10px; margin-bottom: -20px; font-weight:800; color: white; text-align: center; text-shadow: 5px 5px 10px black">B<span style="color: red;">2</span>B Driving School</p>
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td>
                        <p style="font-size: 30px;padding-left:12px;font-weight: 800;">Shedule Manager</p>
                                           
                    </td>
                    <td width="15%">
                                <p style="font-size: 14px;color: white;padding: 0;margin: 0; margin-top: 0px;text-align: right;">
                                    Today's Date
                                </p>
                ...
                <tr>
                    <td colspan="4" >
                        ...
                        <div class="heading-main12" style="margin-left:45px; font-size:20px; font-weight: 800; color:black; margin-top: 5px;">Schedule a Session</div>
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;width: 100%;" >
                        ...
                        <p class="heading-main12" style="margin-left: 45px; font-size:18px; color:black">All Sessions (<?php echo $list110->num_rows; ?>)</p>
                    </td>
                ...
                <tr>
                   <td colspan="4">
                       <center>
                        ...
                        <table width="93%" class="sub-table scrolldown" border="0" style="background-color:white; border:solid; border-color:black;">
                        <thead>
                        <tr>
        ...
        if($action=='add-session'){
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                ...
                                <td class="label-td" colspan="2">
                                    <label for="docid" class="form-label">Select Instructor: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                        ...
                        echo     '       </select><br><br>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="nop" class="form-label">Number of Instrutor/Appointment Numbers : </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <div class="content" style="font-size:35px; color:white; font-weight:800;">
                            Samal <span style="color:#1DC4E7;">Dialysis</span> Center</div>
