    ...
    <div class="container">
        <div class="menu" style="background-color:#2F323A;">
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn " >
                        <a href="index.php" class="non-style-link-menu" style="color: white;"><div><p class="menu-text">Dashboard</p></a></div></a>
                    </td>
                </tr>
                <tr class="menu-row">
                    <td class="menu-btn  menu-active ">
                        <a href="doctors.php" class="non-style-link-menu non-style-link-menu-active" style="color: white;"><div><p class="menu-text">Instructor</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                    <td class="menu-btn ">
                ...
                <tr class="menu-row">
                    <td class="menu-btn ">
                        <a href="appointment.php" class="non-style-link-menu" style="color: white;"><div><p class="menu-text">Appointment</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                    <td class="menu-btn ">
                        <a href="patient.php" class="non-style-link-menu" style="color: white;"><div><p class="menu-text">Clients</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                    <td class="menu-btn ">
        ...
        <div class="dash-body">
            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    <td width="13%">
                        <a href="doctors.php" ><button  class="login-btn btn-primary-soft btn btn-icon-back"  style=" color: black;padding-top:11px; padding-bottom:11px; margin-left:20px; width:125px"><font class="tn-in-text">Back</font></button></a>
                    </td>
                    <td>
...
?>
                ...
                <tr >
                    <td colspan="2" style="padding-top:30px;">
                        <p class="heading-main12" style="margin-left:45px; font-size:25px; font-weight: 800; color:rgb(49, 49, 49)">Add New Instructor</p>
                    </td>
                    <td colspan="2">
                        <a href="?action=add&id=none&error=0" class="non-style-link"><button  class="login-btn btn-primary btn button-icon"  style="display:flex; justify-content: center; align-items: center; margin-left:-800px; margin-top: 30px; background-image: url('../img/icons/add.svg');">Add New</font></button>
                            </a></td>
                </tr>
                <tr>
                    <td colspan="4" style="padding-top:10px;">
                        <p class="heading-main12" style="margin-left:45px; font-size:20px; color: black">All Instructor (<?php echo $list11->num_rows; ?>)</p>
                    </td>
                ...
                <tr>
                   <td colspan="4">
                       <center>
                        ...
                        <table width="93%" class="sub-table scrolldown" border="0" style="background-color: white; border:solid;">
                        <thead>
                        <tr>
        ...
        if($action=='drop'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        <h2></h2>
                        <a class="close" href="doctors.php">&times;</a>
                        <div class="content" style="font-size:35px; color:white; font-weight:800;">
                            Samal <span style="color:#1DC4E7;">Dialysis</span> Center<br>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <a class="close" href="doctors.php" style="color:white;">&times;</a> 
                        <div style="display: flex;justify-content: center;">
                        <div class="abc">
                        <div class="content" style="font-size:35px; color:white; font-weight:800;">
                            B<span style="color:red;">2</span>B Driving School</div>
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0" style="background-color:white;">
                        <tr>
                                <td class="label-td" colspan="2">'.
                                    $errorlist[$error_1]
                            ...
                            <tr>
                                <td>
                                    <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Add New Instructor.</p><br><br>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="name" class="input-text" placeholder="Instructor Name" required><br>
                                </td>
                        ...
                        echo     '       </select><br>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="password" name="cpassword" class="input-text" placeholder="Re-type Password" required><br>
                                </td>
                            </tr>
                    ...
                    <div id="popup1" class="overlay">
                            ...
                            B<span style="color:red;">2</span>B Driving School</div>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Edit Instructor Details.</p>
