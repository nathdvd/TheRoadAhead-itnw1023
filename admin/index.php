                        ...
                        <tr >
                            ...
                            <td colspan="2" class="nav-bar" >
                                ...
                                <form action="doctors.php" method="post" class="header-search">
                                    ...
                                    <input type="search" name="search" class="input-text header-searchbar" placeholder="Search Instructor name or Email" list="doctors">&nbsp;&nbsp;
                ...
                <tr>
                    <td colspan="4">
                        ...
                        <table class="filter-container" style="border: none;" border="0" >
                            <tr>
                                <td colspan="4">
                                    <p style="font-size: 25px; text-shadow: 2px 2px 2px black; color: white; font-weight:800; padding-left: 12px;">Status</p>
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 25%;" >
                                    <div  class="dashboard-items"  style=" border: solid; border-color: black; background-color: white; padding:20px; margin:auto; width:95%; display: flex">
                                        <div>
                                ...
                                <td style="width: 25%;">
                                    <div  class="dashboard-items"  style=" border: solid; border-color: black; padding:20px;  margin:auto; width:95%; background-color: white; display: flex;">
                                        <div>
                                                <div class="h1-dashboard">
                                ...
                                <td style="width: 25%;">
                                    <div  class="dashboard-items"  style=" border: solid; border-color: black; padding:20px; margin:auto; width:95%; display: flex; background-color: white; ">
                                        <div>
                                                <div class="h1-dashboard">
                ...
                <tr>
                    <td colspan="4">
                        <table width="100%" border="0" class="dashbord-tables">
                            <tr>
                                <td>
                                    <p style="padding:10px; padding-left:100px; padding-bottom:0; font-size:23px; font-weight:700; color:black; text-shadow: .5px .5px .5px white;">
                                        Upcoming Appointments until Next <?php  
                                        echo date("l",strtotime("+1 week"));
                                        ?>
                                    </p>
                                    <p style="padding-bottom:19px; padding-left:150px; font-size:15px; font-weight:400; color: white; text-shadow: .5px .5px .5px black; line-height: 20px;">
                                        Access to Upcoming Appointments until 7 days<br>
                                        More details available in Appointment section.
                                    </p>

                                </td>
                                <td>
                                    <p style="text-align:right; padding:10px; padding-right:100px; padding-bottom:0; font-size:23px; font-weight:700; color:black; text-shadow: .5px .5px .5px white;">
                                        Upcoming Sessions  until Next <?php  
                                        echo date("l",strtotime("+1 week"));
                                        ?>
                                    </p>
                                    <p style="padding-bottom:19px; text-align:right; padding-right:150px; font-size:15px; font-weight:400; color: white; text-shadow: .5px .5px .5px black; line-height: 20px;">
                                        Access to Upcoming Sessions that Scheduled until 7 days<br>
                            ...
                            <tr>
                                <td width="50%">
                                    <center>
                                        <div class="abc scroll" style="height: 300px; ">
                                        <table width="85%" class="sub-table scrolldown" border="0" style="background-color: white;">
                                        <thead>
                                        <tr>    
                                ...
                                <td width="50%" style="padding: 0;">
                                    <center>
                                        <div class="abc scroll" style="height: 300px;padding: 0;margin: 0;">
                                        <table width="85%" class="sub-table scrolldown" border="0" style="background-color: white;">
                                        <thead>
                                        <tr>
                                                <th class="table-headin">
