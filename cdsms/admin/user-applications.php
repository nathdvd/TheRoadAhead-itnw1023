...
<head>
    ...
    <title>CDSMS User Applications</title>
            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1> <?php echo $_GET['appname'];?>'s Applications</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="approved-application.php">User Applications</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">View <?php echo $_GET['appname'];?>'s Applications</strong>
                            </div>
                            <div class="card-body">
                                <table class="table">
                                    <thead>
