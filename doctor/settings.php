    ...
    <div class="container">
        <div class="menu" style="background-color:#2F323A;">
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn ">
                        <a href="patient.php" class="non-style-link-menu"><div><p class="menu-text" style="color: white;">My Clients</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                    <td class="menu-btn   menu-active ">
                        <a href="settings.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text" style="color: white;">Settings</p></a></div>
                    </td>
                </tr>
        ...
        <div class="dash-body">
            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                    ...
                    <td>
                        <p style="font-size: 30px; text-shadow: 1px 1px 1px white; padding-left:12px; font-weight:800;">Settings</p>
                        ...
                        <table class="filter-container" style="border: none;" border="0">
                            ...
                            <tr>
                                <td style="width: 25%;">
                                    ...
                                    <div  class="dashboard-items setting-tabs"  style="background-color: white; border: solid; border-color: black; padding:20px; margin:auto; width:95%; display: flex">
                            ...
                            <td style="width: 25%;">
                                    ...
                                    <div  class="dashboard-items setting-tabs"  style=" padding:20px; margin:auto; background-color: white; border: solid; border-color: black; width:95%; display: flex;">
                            ...
                            <td style="width: 25%;">
                                    ...
                                    <div  class="dashboard-items setting-tabs"  style=" padding:20px; margin:auto; width:95%; display:flex; background-color: white; border: solid; border-color: black;">
    ...
    if($_GET){
        ...
        if($action=='drop'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        <h2></h2>
                        <a class="close" href="settings.php" style="color:white;">&times;</a>
                        <div class="content" style="font-size:40px; color:white; font-weight:600;">
                            B<span style="color: red;">2</span>B Driving School<br>
            ...
            $error_1=$_GET["error"];
                $errorlist= array(
                    '1'=>'<label for="promter" class="form-label" style="color:black;text-align:center;">Already have an account for this Email address.</label>',
                    '2'=>'<label for="promter" class="form-label" style="color:black;text-align:center;">Password Confirmation Error! Reconfirm Password</label>',
                    '3'=>'<label for="promter" class="form-label" style="color:black;text-align:center;"></label>',
                    '4'=>"",
                    '0'=>'',
                    ...
                    <div id="popup1" class="overlay">
                            ...
                            B<span style="color: red;">2</span>B Driving School<br>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="tel" name="Tele" class="input-text" maxlength="11" placeholder="Phone Number" value="'.$tele.'" required><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
