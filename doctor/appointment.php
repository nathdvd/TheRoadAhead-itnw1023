    ...
    <div class="container">
        ...
        <div class="dash-body">
            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:5px; ">
                <tr >
                    <td width="13%" >
                    <a href="appointment.php" ><button  class="login-btn btn-primary-soft btn btn-icon-back"  style="padding-top:11px; padding-bottom:11px; margin-left:20px; color: black; width:125px"><font class="tn-in-text">Back</font></button></a>
                    </td>
                    <td>
                        <p style="font-size:30px; padding-left:12px; font-weight:800; text-shadow:1px 1px 1px white;">Appointment Manager</p>
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;width: 100%;" >
                        ...
                        <p class="heading-main12" style="margin-left: 45px; font-weight:600; font-size:20px; color:black;">My Appointments (<?php echo $list110->num_rows; ?>)</p>
                    </td>
