 ...
 <div class="container">
     ...
     <table class="menu-container" border="0">
             ...
             <tr class="menu-row" >
                 <td class="menu-btn  menu-active ">
                     <a href="schedule.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text" style="color: white;">My Sessions</p></div></a>
                 </td>
             </tr>
             <tr class="menu-row" >
                 <td class="menu-btn ">
        ...
        <div class="dash-body">
            ...
            <table border="0" width="100%" style=" border-spacing: 0; margin:0; padding:0; margin-top:5px; ">
                <tr >
                    <td width="13%" >
                    <a href="schedule.php" ><button  class="login-btn btn-primary-soft btn btn-icon-back"  style=" color: black; padding-top:11px; padding-bottom:11px; margin-left:20px; width:125px"><font class="tn-in-text">Back</font></button></a>
                    </td>
                    <td>
                        <p style="font-size:30px; text-shadow: 1px 1px 1px white; padding-left:12px; font-weight: 800;">My Sessions</p>
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;width: 100%;" >
                        ...
                        <p class="heading-main12" style="margin-left:45px; font-weight: 600; font-size:20px; color:black;">My Sessions (<?php echo $list110->num_rows; ?>) </p>
                    </td>
    ...
    if($_GET){
        ...
        if($action=='drop'){
            ...
            echo '
            <div id="popup1" class="overlay">
                    <div class="popup" style="width: 70%; background-color:#2F323A;">
                    <center>
                        <h2></h2>
                        <a class="close" href="schedule.php" style="color:white;">&times;</a>
