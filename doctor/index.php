        ...
        <div class="dash-body"> 
            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                        ...
                        <tr >
                            ...
                            <p style="font-size: 30px; padding-left:12px; text-shadow: 2px 2px 2px black; font-weight: 800; margin-left:20px; color:white; ">Dashboard</p>
                ...
                <tr>
                    ...
                    <center>
                    <table class="filter-container doctor-header" style="border:solid; width:95%" border="0" >
                    <tr>
                        <td >
                            <h3>Welcome!</h3>
                        ...
                        <table border="0" width="100%">
                            <tr>
                                <td width="50%">
                                    ...
                                    <center>
                                        <table class="filter-container" style="border: none;" border="0">
                                            <tr>
                                                <td colspan="4">
                                                    <p style="font-size:25px; font-weight:600; padding-left:12px; text-shadow: .5px .5px .5px white;">Status</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 25%;">
                                                ...
                                                <td style="width: 25%;">
                                                    <div  class="dashboard-items"  style=" border:solid; padding:20px; border-color:black; margin:auto; width:95%; display:flex; background-color:white;">
                                                        <div>
                                                                <div class="h1-dashboard">
                                                ...
                                                <tr>
                                                <td style="width: 25%;">
                                                    <div  class="dashboard-items"  style=" border:solid; padding:20px; background-color: white; border-color:black; margin:auto; width:95%; display:flex; ">
                                                        <div>
                                                                <div class="h1-dashboard" >
                                                ...
                                                <td style="width: 25%;">
                                                    <div  class="dashboard-items"  style="padding:20px; border:solid; background-color: white; margin:auto; width:95%; border-color:black; display:flex; padding-top:21px; padding-bottom:21px;">
                                                        <div>
                                                                <div class="h1-dashboard">
                                ...
                                <td>
                                    ...
                                    <p id="anim" style="font-size: 20px; font-weight:600; padding-left:150px; text-shadow:1px 1px 1px white;">Your Up Coming Sessions until Next week</p>
                                    <center>
                                        <div class="abc scroll" style="height:250px; padding: 0;margin: 0;">
                                        <table width="85%" class="sub-table scrolldown" border="0" style="background-color: white; border: solid;" >
                                        <thead>
